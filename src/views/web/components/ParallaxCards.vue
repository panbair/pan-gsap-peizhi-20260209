<template>
  <section class="pc-parallax-cards-section">
    <div class="pc-content">
      <h2 class="pc-section-title">视差卡片</h2>
      <p class="pc-subtitle">滚动时卡片产生深度层次效果</p>

      <div class="pc-cards-container">
        <div class="pc-card" ref="card1">
          <div class="pc-card-content">
            <div class="pc-card-icon">🚀</div>
            <h3>极速性能</h3>
            <p>优化的动画性能，流畅丝滑的用户体验</p>
          </div>
          <div class="pc-card-bg" ref="bg1"></div>
        </div>

        <div class="pc-card" ref="card2">
          <div class="pc-card-content">
            <div class="pc-card-icon">🎨</div>
            <h3>创意设计</h3>
            <p>现代化的设计风格，吸引眼球的视觉效果</p>
          </div>
          <div class="pc-card-bg" ref="bg2"></div>
        </div>

        <div class="pc-card" ref="card3">
          <div class="pc-card-content">
            <div class="pc-card-icon">⚡</div>
            <h3>交互反馈</h3>
            <p>丰富的交互细节，提升用户参与度</p>
          </div>
          <div class="pc-card-bg" ref="bg3"></div>
        </div>
      </div>
    </div>
  </section>
